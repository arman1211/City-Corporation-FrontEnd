...
const ProblemReportModal = ({ problem, isOpen, onClose }) => {
    ...
    try {
      ...
      if (response.ok) {
        showToast({
          title: "Success",
          description:
            "Your Problem is reported Successfully. Please wait for solve...",
          status: "success",
        });
        onClose();
      } else {
    ...
    <div className="fixed inset-0 bg-black bg-opacity-30 flex justify-center items-center">
      <div className="modal-box bg-white p-6 rounded-md shadow-lg max-w-lg w-full">
        ...
        <p className="text-base text-gray-700 mb-2">
          Problem Name: <span className="font-medium">{problem.name}</span>
        </p>
