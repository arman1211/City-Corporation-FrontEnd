...
import ServiceSolveModal from "./ServiceSolveModal";
      ...
      {loading ? (
        ...
        <div>
          <h1 className="text-2xl font-semibold text-center my-6">
            All Service Requests By Citizen
          </h1>
              ...
              <table className="table-auto w-full m-auto border-collapse">
                <thead>
                  <tr className="bg-gray-100">
                    ...
                    <th className="px-4 py-2 text-left border">Service Type</th>
