    ...
    const fetchProblemReports = async () => {
      try {
        const response = await axios.get(
          "http://127.0.0.1:8000/services/problem-type/list/"
        );
  ...
  return (
    <div className="bg-base-100 shadow-lg p-10 rounded">
      <div className="overflow-x-auto">
        <h2 className="font-bold text-center text-4xl text-red-500 mb-6">
          All Problem Type List
        </h2>
              ...
              <tr key={problem.id}>
                ...
                <td>
                  <button
                    ...
                    onClick={() => handleEditModal(problem.id)}
                  >
                ...
                <td>
                  <button
                    className="btn btn-sm"
                    onClick={() => handleDeleteModal(problem.id)}
                  >
...
export default ProblemReportControl;
